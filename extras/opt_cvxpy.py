...
def get_torque_cvxpy(dyn):
    ...
    b_trq=np.zeros((40))
    b_trq[0:20]=dyn.trq_range[0:20,0]             # Max limit
    b_trq[20:40]=dyn.trq_range[0:20,1]            # Min limit
